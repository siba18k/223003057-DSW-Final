      ...
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <View style={styles.content}>
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity style={[styles.signInButton, loading && styles.disabledButton]} onPress={handleSignIn} disabled={loading}>
              {loading ? (
...
const styles = StyleSheet.create({
  ...
  signInButton: { ...commonStyles.button },
  disabledButton: { backgroundColor: colors.textSecondary },
  signInButtonText: { ...commonStyles.buttonText },
  footer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center' },
  footerText: { ...typography.body, color: colors.textSecondary },
  signUpText: { ...typography.body, color: colors.primary, fontWeight: '600' },
});
